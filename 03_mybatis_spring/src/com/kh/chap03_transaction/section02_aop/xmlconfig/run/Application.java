package com.kh.chap03_transaction.section02_aop.xmlconfig.run;
...
import com.kh.chap03_transaction.section02_aop.xmlconfig.model.service.OrderService;
...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		/* AOP를 적용한 트랜잭션 관리 (xml 설정) */
		
		ApplicationContext context 
			= new GenericXmlApplicationContext("com/kh/chap03_transaction/section02_aop/xmlconfig/config/spring-context.xml");
