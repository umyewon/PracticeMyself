package com.kh.chap03_transaction.section01_programmatic.run;
...
import com.kh.chap03_transaction.section01_programmatic.model.service.OrderService;
...
public class Application {
	...
	public static void main(String[] args) {
		/* 프로그래밍 레벨에서 트랜잭션 처리 방법 
		 * 기존 마이바티스 사용 시 sqlSession.commit(), sqlSession.rollback() 메소드 이용함 
		 * 스프링과 연동 환경에서 이 메소드를 사용하면 UnsupportedOperationException 발생
		 * 스프링과 연동한 환경에서 수동으로 트랜잭션을 제어하고자 한다면 PlatformTransactionManager 사용
		 * */
		
		ApplicationContext context 
			= new GenericXmlApplicationContext("com/kh/chap03_transaction/section01_programmatic/config/spring-context.xml");
