package com.kh.chap08_init_destroy_method.xmlconfig;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context
			= new GenericXmlApplicationContext("com/kh/chap08_init_destroy_method/xmlconfig/config/spring-context.xml");
		...
		((GenericXmlApplicationContext)context).close(); 	// 실제 구현체 클래스로 context 다운 캐스팅 필요
